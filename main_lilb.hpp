...
private:
	Greed::abs_pos absolute_position;//this position of the bullet is not according to the system specific display, but according to the game world
	int ttl;
	bool hit_or_not;
...
class top_layer;
class pack_ship;
void update_frame(deque<ship*>&, pack_ship&, int);
class timeline
{
public:
...
private:
	...
	deque<timeline> time_line1;//the original time line
